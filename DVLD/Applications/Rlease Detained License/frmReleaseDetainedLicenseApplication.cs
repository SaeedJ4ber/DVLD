...
namespace DVLD.Applications.Rlease_Detained_License
{
    public partial class frmReleaseDetainedLicenseApplication : Form
    {
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            lblCreatedByUser.Text = clsCredentialManager.CurrentUser.UserName;
        ...
        private void btnRelease_Click(object sender, EventArgs e)
        {
            ...
            bool IsReleased = ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.ReleaseDetainedLicense(clsCredentialManager.CurrentUser.UserID,ref ApplicationID); ;
