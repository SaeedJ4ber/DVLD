...
namespace DVLD
{
    ...
    public partial class frmMain : Form
    {
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            lblLoggedInUser.Text = "LoggedIn User: " + clsCredentialManager.CurrentUser.UserName;
            this.Refresh();
        ...
        {
            frmUserInfo frm = new frmUserInfo(clsCredentialManager.CurrentUser.UserID);
            frm.ShowDialog();
        ...
        {
            clsCredentialManager.CurrentUser = null;
            _frmLogin.Show();
            this.Close();
        }
        ...
        {
            frmChangePassword frm = new frmChangePassword(clsCredentialManager.CurrentUser.UserID);
            frm.ShowDialog();
